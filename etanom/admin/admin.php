...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        ...
        <button class="btn btn-sm py-1 rounded-0" style="background-color: rgb(21, 122, 80); color: white;" type="button" id="create_new">Add New</button>
        </div>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="text-center py-0 px-1">
                        ...
                        <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle btn-sm rounded-0 py-0" style="background-color: rgb(21, 122, 80); color: white;" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                            </button>
