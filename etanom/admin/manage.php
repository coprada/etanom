            ...
            <div class="row h-100">
                <div class="col-md-5">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Crops</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                        <a href="javascript:void(0)" id="new_category" class="btn btn-sm rounded-2" style="background-color: rgb(83, 178, 138);" title="Add Category"><span class="fa fa-plus"></span></a>
                        </div>
                    </div>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex">
                                ...
                                <div class="col-auto d-flex justify-content-end">
                                    <a href="javascript:void(0)" class="view_category btn btn-sm btn-info text-light bg-gradient py-0 px-1 me-1" style="background-color: rgb(83, 178, 138);" title="View Category Details" data-id="<?php echo $row['category_id'] ?>"><span class="fa fa-th-list"></span></a>
                                    <a href="javascript:void(0)" class="edit_category btn btn-sm btn-primary bg-gradient py-0 px-1 me-1" style="background-color: darkgreen; color: white;" title="Edit Category Details" data-id="<?php echo $row['category_id'] ?>" data-name="<?php echo $row['name'] ?>"><span class="fa fa-edit"></span></a>
                ...
                <div class="col-md-7">
                    <div class="fs-5 col-auto flex-grow-1"><b>Etanom</b></div>
                    <form action="" id="settings-form">
                        <div class="form-group">
                            <label for="welcome" class="control-label">Welcome</label>
                        ...
                        <button class="btn btn-sm btn-primary rounded-0 my-1" style="background-color: rgb(83, 178, 138);">Update</button>
                        </div>
                    </form>
            </div>
            </div>
