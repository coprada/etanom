...
if($_SESSION['type'] != 1 && in_array($page,array('Manage','Vacancys','stocks'))){
    header("Location:./");
    exit;
}
?>
...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: rgb(21, 122, 80);" id="topNavBar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'crops')? 'active' : '' ?>" href="./?page=crops">Crops</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="http://localhost/final/etanom/php-sqlite-forum/?page=users">Com User</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=manage">Manage</a>
                    </li>
                    <?php endif; ?>
    ...
    <div class="modal fade" id="uni_modal" role='dialog' data-bs-backdrop="static" data-bs-keyboard="true">
        ...
        <button type="button" class="btn btn-sm rounded-0" style="background-color: rgb(21, 122, 80); color: white;" id="submit" onclick="$('#uni_modal form').submit()">Save</button>
