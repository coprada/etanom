...
<div class="card">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($_GET['id'])? "Update" :"Create New" ?> Crops Content</h5>
    </div>
    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="title" class="control-label">Crops Title</label>
                            ...
                            <div class="form-group">
                                <label for="category_id" class="control-label">Seasonal Category</label>
                            ...
                            <div class="form-group">
                                <label for="image" class="control-label">Crops Image</label>
                                <input type="file" name="image" id="image" <?php echo !isset($Crops_id)? "required" : "" ?> class="form-control form-control-sm rounded-0" accept="image/png">
                            </div>
                            <div class="form-group">
                                <label for="planning" class="control-label">All About:</label>
                                <textarea name="planning" id="planning" cols="30" rows="3" class="form-control rounded-0 summernote" data-placeholder="Write the planning here." data-height="30vh" required><?php echo isset($planning) ? $planning : '' ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="land_preparation" class="control-label">Time Of Planting</label>
                                <textarea name="land_preparation" id="land_preparation" cols="30" rows="3" class="form-control rounded-0 summernote" data-placeholder="Write the land preparation  here." data-height="30vh" required><?php echo isset($land_preparations) ? $Land_preparation : '' ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="planting_stages" class="control-label">Soil Types And Soil Ph</label>
                                <textarea name="planting_stages" id="planting_stages" cols="30" rows="3" class="form-control rounded-0 summernote" data-placeholder="Write the planting_stages here." data-height="40vh" required><?php echo isset($planting_stages) ? $planting_stages : '' ?></textarea>
                            </div>
                            <div class="form-group">
    ...
    <div class="card-footer">
        <div class="col-12 d-flex justify-content-end">
            <div class="col-auto">
            <button class="btn rounded-0 me-2" form="crops-form" style="background-color: rgb(21, 122, 80); color: white;">Save</button>
