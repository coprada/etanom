...
if(!is_dir(__DIR__.'./db'))
    mkdir(__DIR__.'./db');
if(!defined('db_file')) define('db_file',__DIR__.'./db/etanom_db.db');
...
Class DBConnection extends mysql{
    ...
    function __construct(){
        ...
        $this->exec("CREATE TABLE IF NOT EXISTS `crops_list` (
            `crops_id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
        ...
        $this->exec("INSERT or IGNORE INTO `user_list` VALUES (1,'Realyn Beridico Coprada','Rbc',md5('Rdc123'),1, CURRENT_TIMESTAMP)");
